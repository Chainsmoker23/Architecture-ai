...
const themes = {
  light: {
    ...
    '--color-shadow': '#000000',
    '--color-tier-1': 'rgba(249, 215, 227, 0.2)',
    '--color-tier-2': 'rgba(219, 234, 254, 0.25)',
    '--color-tier-3': 'rgba(209, 250, 229, 0.25)',
    '--color-tier-4': 'rgba(254, 240, 169, 0.25)',
    '--color-tier-5': 'rgba(233, 213, 255, 0.25)',
    '--color-tier-6': 'rgba(229, 231, 235, 0.3)',
    '--color-tier-default': 'rgba(229, 231, 235, 0.3)',
  },
  medium: {
    '--color-bg': '#F2E5E9',
    ...
    '--color-tier-2': 'rgba(210, 222, 241, 0.3)',
    '--color-tier-3': 'rgba(201, 236, 219, 0.3)',
    '--color-tier-4': 'rgba(240, 229, 163, 0.3)',
    '--color-tier-5': 'rgba(224, 204, 242, 0.3)',
    '--color-tier-6': 'rgba(220, 222, 225, 0.4)',
    '--color-tier-default': 'rgba(220, 222, 225, 0.4)',
  },
  dark: {
    '--color-bg': '#1E1E1E',
    ...
    '--color-shadow': '#000000',
    '--color-tier-1': 'rgba(255, 155, 178, 0.05)',
    '--color-tier-2': 'rgba(147, 197, 253, 0.05)',
    '--color-tier-3': 'rgba(110, 231, 183, 0.05)',
    '--color-tier-4': 'rgba(252, 211, 77, 0.05)',
    '--color-tier-5': 'rgba(196, 181, 253, 0.05)',
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        // FIX: The 'unknown' error type was causing a TypeScript error when being stringified in a template literal.
        // The idiomatic way to log an unknown error is to pass it as a separate argument to console.error,
        // which also provides better object inspection in browser developer tools.
