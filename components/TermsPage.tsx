        ...
        <section className="py-24 bg-white">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <TermsSection title="1. Acceptance of Terms">
                    <p>By accessing or using ArchiGen AI (the "Service"), you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to all of these terms, do not use the Service.</p>
                </TermsSection>

                <TermsSection title="2. Description of Service">
                    <p>ArchiGen AI is a web application that allows users to generate software architecture diagrams automatically from natural language prompts. The Service utilizes third-party AI models, such as Google's Gemini API, to interpret prompts and produce diagram data.</p>
                </TermsSection>
                ...
                <TermsSection title="5. Intellectual Property">
                    ...
                    <p>All aspects of the ArchiGen AI Service itself, including its design, text, graphics, and code, are the property of ArchiGen AI and are protected by copyright and other intellectual property laws.</p>
                </TermsSection>
                ...
                <TermsSection title="7. Limitation of Liability">
                    <p>In no event shall ArchiGen AI, its creators, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or in connection with your use of the Service.</p>
                </TermsSection>
