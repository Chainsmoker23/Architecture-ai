...
const ContextualActionBar: React.FC<ContextualActionBarProps> = ({ position, onDelete, onDuplicate, onToggleProperties, selectedCount }) => {
    return (
        <motion.div
        ...
        >
            ...
            {selectedCount === 1 && (
                <>
                    ...
                    <ActionButton title="Properties" onClick={onToggleProperties}>
