...
export const ICONS: Record<string, React.ReactNode> = {
  ...
  [IconType.Graph]: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 13.5l3-3 3 3 3-3 3 3M3 3v18h18" stroke="currentColor" fill="none" />,
...
export const EXAMPLE_PROMPTS_LIST = [
    ...
    "A line graph showing monthly active users. Jan: 100, Feb: 150, Mar: 130, Apr: 220, May: 300, Jun: 500.",
...
export const AVATARS = [
    { name: 'Fox', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M16 8.5C16 9.88 14.88 11 13.5 11H3.5C2.12 11 1 9.88 1 8.5V4.5C1 3.12 2.12 2 3.5 2h10C14.88 2 16 3.12 16 4.5V8.5z M23 15.5c0 1.38-1.12 2.5-2.5 2.5h-10c-1.38 0-2.5-1.12-2.5-2.5V11.5c0-1.38 1.12-2.5 2.5-2.5H12l4-4 4 4h2.5c1.38 0 2.5 1.12 2.5 2.5v4z"/></svg>` },
    { name: 'Bear', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 12c0-2.21-1.79-4-4-4H8c-2.21 0-4 1.79-4 4v5h16v-5z M7.5 12c-.83 0-1.5.67-1.5 1.5S6.67 15 7.5 15s1.5-.67 1.5-1.5S8.33 12 7.5 12zm9 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z M12 3c-3.86 0-7 3.14-7 7h14c0-3.86-3.14-7-7-7z"/></svg>` },
    { name: 'Cat', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 3H4C2.9 3 2 3.9 2 5v14c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9.5 17c-.83 0-1.5-.67-1.5-1.5S8.67 14 9.5 14s1.5.67 1.5 1.5S10.33 17 9.5 17zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 14 14.5 14s1.5.67 1.5 1.5S15.33 17 14.5 17zm-5-5c-.83 0-1.5-.67-1.5-1.5S8.67 9 9.5 9s1.5.67 1.5 1.5S10.33 12 9.5 12zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 9 14.5 9s1.5.67 1.5 1.5S15.33 12 14.5 12z M4 1v2.5L2 5h20l-2-1.5V1H4z"/></svg>` },
    { name: 'Dog', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 6c0-1.1-.9-2-2-2h-4v2h4v12H6V6h4V4H6C4.9 4 4 4.9 4 6v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6z M12 1c-2.21 0-4 1.79-4 4v2h8V5c0-2.21-1.79-4-4-4zm-2 9c-.83 0-1.5.67-1.5 1.5S9.17 13 10 13s1.5-.67 1.5-1.5S10.83 10 10 10zm4 0c-.83 0-1.5.67-1.5 1.5S13.17 13 14 13s1.5-.67 1.5-1.5S14.83 10 14 10z"/></svg>` },
    { name: 'Panda', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.5 14c-.83 0-1.5-.67-1.5-1.5S15.67 13 16.5 13s1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm-9 0c-.83 0-1.5-.67-1.5-1.5S6.67 13 7.5 13s1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM12 9c-1.93 0-3.5 1.57-3.5 3.5h7c0-1.93-1.57-3.5-3.5-3.5zm-3.5-2.5c-.83 0-1.5-.67-1.5-1.5S7.67 3.5 8.5 3.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm7 0c-.83 0-1.5-.67-1.5-1.5S14.67 3.5 15.5 3.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/></svg>` },
    { name: 'Rabbit', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C9.24 2 7 4.24 7 7v1c0 .55-.45 1-1 1s-1-.45-1-1V7c0-3.86 3.14-7 7-7s7 3.14 7 7v1c0 .55-.45 1-1 1s-1-.45-1-1V7c0-2.76-2.24-5-5-5z M20 12c-1.1 0-2 .9-2 2v2c0 3.31-2.69 6-6 6s-6-2.69-6-6v-2c0-1.1-.9-2-2-2s-2 .9-2 2v2c0 4.41 3.59 8 8 8s8-3.59 8-8v-2c0-1.1-.9-2-2-2z"/></svg>` },
    { name: 'Koala', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM8.5 8C7.67 8 7 8.67 7 9.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S9.33 8 8.5 8zm7 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S16.33 8 15.5 8zM12 13c-2.33 0-4.31 1.46-5.11 3.5h10.22c-.8-2.04-2.78-3.5-5.11-3.5z"/></svg>` },
    { name: 'Owl', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM8.5 10c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S9.33 10 8.5 10zm7 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S16.33 10 15.5 10zM12 14.5c1.66 0 3-1.34 3-3H9c0 1.66 1.34 3 3 3z"/></svg>` },
    { name: 'Lion', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM9 10c-.55 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1zm6 0c-.55 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1zm-3 4c-1.48 0-2.75-.81-3.45-2H15.45c-.7 1.19-1.97 2-3.45 2zM4.03 8.97l1.41 1.41C6.26 9.56 7.5 9 9 9v2c-1.04 0-2.08.31-2.97.97L4.65 10.6 4.03 8.97zM20 12c0-1.5-.56-2.74-1.38-3.72l1.41-1.41-1.63-1.63-1.38 1.38C17.04 7.31 16.01 7 15 7v2c1.5 0 2.74.56 3.72 1.38l-1.41 1.41 1.63 1.63 1.38-1.38z"/></svg>` },
    { name: 'Tiger', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM4 19V5h16v14H4zM6 9h2v2H6zm4 0h2v2h-2zm4 0h2v2h-2zm-8 4h2v2H6zm4 0h2v2h-2zm4 0h2v2h-2z"/></svg>` },
    { name: 'Penguin', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 16H9v-2h2v2zm2-2h2v2h-2v-2zm-4-4H7v-2h2v2zm8 0h-2v-2h2v2zm-4-4c-1.1 0-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4h-2c0-1.1-.9-2-2-2z"/></svg>` },
    { name: 'Monkey', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM9.5 9c-.83 0-1.5.67-1.5 1.5S8.67 12 9.5 12s1.5-.67 1.5-1.5S10.33 9 9.5 9zm5 0c-.83 0-1.5.67-1.5 1.5S13.67 12 14.5 12s1.5-.67 1.5-1.5S15.33 9 14.5 9zm-5 5c-1.1 0-2 .9-2 2h4c0-1.1-.9-2-2-2z"/></svg>` },
    { name: 'Elephant', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 12c0-2.76-2.24-5-5-5h-1V5h2V3h-2c-1.1 0-2 .9-2 2v2h-2c-2.76 0-5 2.24-5 5v5h2v-2c0-1.65 1.35-3 3-3h1v7h2v-7h1c1.65 0 3 1.35 3 3v2h2v-5zm-5-3c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-4 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/></svg>` },
    { name: 'Giraffe', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2h-4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 4h2v2H9V4zm5 0h-2v2h2V4zM7 18h2v2H7zm10 0h-2v2h2zM9 18h2v2H9zm4 0h-2v2h2z M4 20h2v2H4zm14 0h2v2h-2z"/></svg>` },
    { name: 'Squirrel', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C9.24 2 7 4.24 7 7c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2 0-2.76-2.24-5-5-5zm0 10c-2.21 0-4 1.79-4 4v2c0 2.21 1.79 4 4 4s4-1.79 4-4v-2c0-2.21-1.79-4-4-4z"/></svg>` },
    { name: 'Deer', svg: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.14 2 5 5.14 5 9c0 1.1.9 2 2 2h1v2c0 2.21-1.79 4-4 4v2h2c1.1 0 2-.9 2-2v-2h4v2c0 1.1.9 2 2 2h2v-2c-2.21 0-4-1.79-4-4v-2h1c1.1 0 2-.9 2-2 0-3.86-3.14-7-7-7zm-4 7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm8 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/></svg>` },
];